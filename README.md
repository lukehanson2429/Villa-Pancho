...
* [Javascript](https://en.wikipedia.org/wiki/JavaScript) via Bootstrap JavaScript plugins built on jQuery
...
1. As a new user I want to be able to understand the site layout clearly to navigate to my final destination.
    * Navbar links are clearly defined in the Navbar at the top right of the website to access Home, Menu & Contact Pages.
    * Hero Image and text clearly defines the purpose of the website showing it is a restaurant/bar.

2.  As a new user I want to know more about the restaurant, what they are offering and why I would want to visit.
    * Welcome section paragraph detailed under hero image explaining more about the restaurant/bar.
    * Origins & Party at Pancho's section detail further information.

3. As a new user I want to know more about the food and drinks menu to see whether the food/drinks suits my taste and to see the cost.
    * Menu link in Navbar takes you to the Menu Page detailing everything on the menu and the cost.

4. As a new user I want to be able to contact the restaurant should i would like to make a reservation.
    * Contact link in Navbar takes you to the Contact Page to a booking form to make a reservation and detail any special requirements/make an enquiry.
    * Phone Number & Social links also clearly detailed in footer of each page as an another route to make contact.

5. As a new user I"m interested in seeing reviews to see other customers thoughts on the restaurant/bar.
    * Testimonials/Reviews section detailed on home page giving you an idea on what other customers say.

6. As a new user I want to know if there are any offers on at the moment.
    * Weekly offers section clearly detailed on home page explaining this and may assist and what day you would like to make a reservation depending if you are a young adult, family, etc.

7. As an existing user I would like to get in contact to make a reservation.
    * Contact page one click away in Navbar link to make a a reservation. Alternatively can call using phone number detailed in footer.
...
1. Log in to GitHub and locate the [GitHub Repository](https://github.com/lukehanson2429/Villa-Pancho)
2. At the top of the Repository (not top of page), locate the "Settings" Button on the menu.
    - Alternatively Click [Here](https://raw.githubusercontent.com/) for a GIF demonstrating the process starting from Step 2.
3. Scroll down the Settings page until you locate the "GitHub Pages" Section.
4. Under "Source", click the dropdown called "None" and select "Master Branch".
5. The page will automatically refresh.
6. Scroll back down through the page to locate the now published site [link](https://lukehanson2429.github.io/Villa-Pancho/index.html) in the "GitHub Pages" section.
